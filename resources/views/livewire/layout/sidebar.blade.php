                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Create
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="create-password-basic.html" class="side-menu__item">Basic</a>
                                </li>
                                <li class="slide"><a href="create-password-cover.html" class="side-menu__item">Cover</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Reset Password<i
                                    class="fe fe-chevron-right side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="reset-password-basic.html" class="side-menu__item">Basic</a>
                                </li>
                                <li class="slide"><a href="reset-password-cover.html" class="side-menu__item">Cover</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two-Step
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="two-step-verfication-basic.html"
                                        class="side-menu__item">Basic</a></li>
                                <li class="slide"><a href="two-step-verfication-cover.html"
